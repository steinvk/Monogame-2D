...
{   
    /// <summary>
    /// The state of the mouse input during previous update cycle
    /// </summary>
    ...
    /// <summary>
    /// Returns a value indicates whether the specified mouse button was just pressed on the current frame.
    /// </summary>
    /// <param name="button">The mouse button to check</param>
    ...
    public bool WasButtonJustReleased(MouseButton button)
    {
        ...
        {
            case MouseButton.Left:
                return CurrentState.LeftButton == ButtonState.Released && PreviousState.LeftButton == ButtonState.Released;
            case MouseButton.Middle:
                return CurrentState.MiddleButton == ButtonState.Released && PreviousState.MiddleButton == ButtonState.Released;
            case MouseButton.Right:
                return CurrentState.RightButton == ButtonState.Released && PreviousState.RightButton == ButtonState.Released;
            case MouseButton.XButton1:
                return CurrentState.XButton1 == ButtonState.Released && PreviousState.XButton1 == ButtonState.Released;
            case MouseButton.XButton2:
                return CurrentState.XButton2 == ButtonState.Released && PreviousState.XButton2 == ButtonState.Released;
            default:
                return false;
    ...
    /// <summary>
    /// Sets the current position of the mouse cursor in screen space and update the CurrentState
    /// </summary>
