...
{    
    ...
    /// <summary>
    /// Get the total number of columns in this tilemap
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the scale factor to draw each at.
    /// </summary>
    public Vector2 Scale {get;set;}

    /// <summary>
    /// Gets the width, in pixel, each tile is drawn at.
    /// </summary>
    ...
    /// <param name="tilesetID">The tileset id of the tile from the tilset to use.</param>
    ...
    public static Tilemap FromFile(ContentManager content, string filename)
    {
        ...
        using (Stream stream = TitleContainer.OpenStream(filePath))
        {
            using (XmlReader reader = XmlReader.Create(stream))
            {
                ...
                //
                // Example
                // <Tileset region="0 0 100 100" tileWidht="10" tileHeight="10">contentPath</Tileset>
                //
                // The region attribute represent the x, y, width, and height
                // component of the boundary for the texture region within the
                ...
                // The <Tiles> element containes lines of string where each line
                // represents a row in the tilemap. Each line is a space
                // seperated string where each element represent a column in the
