...
public class TitleScene : Scene
{
    ...
    // The origian to set for the dungeon text.
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        // draw the background patterin first using the PointWrap sampler state.
        Core.SpriteBatch.Begin(samplerState: SamplerState.PointWrap);
        Core.SpriteBatch.Draw(_backgroundPattern, _backgroundDestination, new Rectangle(_backgroundOffset.ToPoint(),
