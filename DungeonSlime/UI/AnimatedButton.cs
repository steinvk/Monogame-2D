...
internal class AnimatedButton : Button
{
    public AnimatedButton(TextureAtlas atlas)
    {
        ...
        // texture coordinates for the background is set down below
        ...
        // Get the multiframe animation for the focused button state from the atlas
        ...
        // Create the highlighted+focused stae ( for mouse hover while focused)
        StateSave highlightFocused = buttonVisual.States.HighlightedFocused;
        highlightFocused.Apply = focusedState.Apply;

        // create the hightlighted state (for mouse hover)
    ...
    /// <summary>
    /// Automatically focus the button when the mouse hover over it
    /// </summary>    
