...
public class Slime
{
    // A constant value that represent the amount of time to wait between
    // movement updates.
    ...
    // Normalized value (0-1) representing progress between movement tics for visual interpolation
    private float _movementProgress;

    // The next direction to apply to the head of the slime chain during the next movement update
    private Vector2 _nextDirection;

    // The number of pixels to move the head segment during the movement cucle
    ...
    public void Initialize(Vector2 startPosition, float stride)
    {
        ...
        head.At = startPosition;
        head.To = startPosition + new Vector2(_stride, 0);
    ...
    private void Move()
    {
        ...
        // Insert the new adjusted value for the head at the front of the segments 
        // and remove the tail segment. This effectively moves
        // the entire chanin forward without needing to loop through every
        // segment and update iuts "at" and "to" positions.
        ...
        // the head is colliding with a body element and a body collision 
        // has occured
    ...
    public void Grow()
    {
        ...
        // Create a new tail segment that is positioned at grid cell in the
        // reverse direction from the taill moving to the tail
    ...
    public void Update(GameTime gameTime)
    {
        ...
        // Increment the movement time by the frame elapsed time
    ...
    public void Draw()
    {
        foreach(SlimeSegment segment in _segments)
        {
            ...
            // Draw the slime sprite at thje calculated visual positon of this segment
