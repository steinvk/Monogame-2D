...
float4 MainPS(VertexShaderOutput input) : COLOR
{
	...
	// Calculate the grayscale value based on human perception of color
	...
	// Linear interpolation between the grayscale color and original color's
	// rgb values base on the saturation parameter
